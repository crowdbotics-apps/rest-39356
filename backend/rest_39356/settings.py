"""
Django settings for rest_39356 project.
...
WSGI_APPLICATION = 'rest_39356.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rest_39356 API",
    "DESCRIPTION": "API documentation for rest_39356 App",
    "VERSION": "v1",
}
